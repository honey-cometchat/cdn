...
*/
  ...
  (function (root, factory) {
    ...
    Strophe.Connection.prototype = {
      ...
      _connect_cb: function (req, _callback, raw) {
        ...
        if (bodyWrap.getElementsByTagNameNS) {
          hasFeatures =
            bodyWrap.getElementsByTagNameNS(Strophe.NS.STREAM, "features")
              .length > 0;
        } else {
          hasFeatures =
      ...
      authenticate: function (matched) {
        ...
        for (i = 0; i < matched.length - 1; ++i) {
          ...
          for (var j = i + 1; j < matched.length; ++j) {
            if (
              matched[j].prototype.priority > matched[higher].prototype.priority
            ) {
              higher = j;
            }
          }
    ...
    Strophe.Connection.prototype.mechanisms[Strophe.SASLPlain.prototype.name] =
      Strophe.SASLPlain;
    ...
    Strophe.Connection.prototype.mechanisms[Strophe.SASLSHA1.prototype.name] =
      Strophe.SASLSHA1;
    ...
    Strophe.Connection.prototype.mechanisms[Strophe.SASLMD5.prototype.name] =
      Strophe.SASLMD5;
    ...
    Strophe.Bosh.prototype = {
      ...
      _no_auth_received: function (_callback) {
        ...
        this._requests.push(
          new Strophe.Request(
            body.tree(),
            this._onRequestStateChange.bind(this, _callback.bind(this._conn)),
            body.tree().getAttribute("rid")
          )
        );
        this._throttledRequestHandler();
    ...
    Strophe.Websocket.prototype = {
      ...
      _connect_cb_wrapper: function (message) {
        if (
          ...
          var streamStart = new DOMParser().parseFromString(data, "text/xml")
            .documentElement;
          ...
          var elem = new DOMParser().parseFromString(string, "text/xml")
            .documentElement;
      ...
      _onMessage: function (message) {
        ...
        if (message.data === close) {
          ...
          elem = new DOMParser().parseFromString(message.data, "text/xml")
            .documentElement;
          ...
          elem = new DOMParser().parseFromString(data, "text/xml")
            .documentElement;
        }
